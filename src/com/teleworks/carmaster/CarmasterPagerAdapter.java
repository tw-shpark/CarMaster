...
public class CarmasterPagerAdapter extends
	...
	public Fragment getItem(int arg0) {
		...
		default:
			...
			Log.e("CarMaster",
					"Unexpected Error : Cannot found fragment corresponding to argument("
							+ arg0 + ")");
			break;
		}
	...
	public static class CarmasterFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			rootView = inflater.inflate(R.layout.fragment_textonly, container,
					false);
